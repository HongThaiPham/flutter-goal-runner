...
import 'package:fluttergoalrunner/src/repository/repository.dart';
...
class LoginBloc {
  ...
  Future<int> submit() =>
      _repository.authenticateuser(_email.value, _password.value);

  Future<FirebaseUser> login() => _repository.authenticateFirebase();
